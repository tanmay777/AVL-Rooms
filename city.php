...
if(isset($_SESSION['username']))
{
  $link = mysqli_connect("localhost", "root", "", "users");
  $username = $_SESSION['username'];
  $sql_session = "SELECT * FROM user_details WHERE user_email = '".$username."'";
...
<body>
       ...
       <div class="avl-heading">
        ...
        <form class="houseType" onsubmit="return false" >
          <h5>Type of House</h5>
            <ul>
              <li>
                <input class="filled-in filter1" onclick="document.getElementById('3BHK').click();" type="checkbox" id="3bhk" name="type" value="3BHK" 
                <?php 
          ...
          <label for="3bhk">3 BHK</label>
              ...
              <li>
                <input class="filled-in filter1" onclick="document.getElementById('2BHK').click();" type="checkbox" id="2bhk" name="type" value="2BHK"  
          ...
          <label for="2bhk">2 BHK</label>
              ...
              <li>
                <input class="filled-in filter1" onclick="document.getElementById('1BHK').click();" type="checkbox" id="1bhk" name="type" value="1BHK"  
          ...
          <li>
                <input class="filled-in filter1" type="checkbox" onclick="document.getElementById('SHARING').click();" id="sharing" name="type" value="single_room"  
                <?php 
          ...
          <label for="sharing">Single Room</label>
              ...
              <li>
                <input class="filled-in filter1" onclick="document.getElementById('PG').click();" type="checkbox" id="pg" name="type" value="pg"  
          ...
          <li>
                <input class="filled-in filter1" onclick="document.getElementById('SHARED_ROOM').click();" type="checkbox" id="shared_room" name="type" value="shared_room"  
          ...
          <li>
                <input class="filled-in filter1" onclick="document.getElementById('FURNISHED').click();" type="checkbox" id="furnished" name="type" value="furnished" 
          ...
          <div class="priceRange">
            <ul>
              <li>
                <input class="filled-in filter1" onclick="document.getElementById('UPTO1K').click();" type="checkbox" id="upto1k" name="rent" value="1000"  
                ...
                />
          <label for="upto1k">UPTO 1OOO</label>
          </li>
              <li>
                <input class="filled-in filter1" onclick="document.getElementById('UPTO3K').click();" type="checkbox" id="upto3k" name="rent" value="3000"  
                ...
                />
          <label for="upto3k">UPTO 3OOO</label>
          </li>
              <li>
                <input class="filled-in filter1" onclick="document.getElementById('UPTO5K').click();" type="checkbox" id="upto5k" name="rent" value="5000"  
                ...
                />
          <label for="upto5k">UPTO 5OOO</label>
          </li>
              <li>
                <input class="filled-in filter1" onclick="document.getElementById('UPTO8K').click();" type="checkbox" id="upto8k" name="rent" value="8000"  
                ...
                />
          <label for="upto8k">UPTO 8OOO</label>
          </li>
          <li>
                <input class="filled-in filter1" onclick="document.getElementById('UPTO12K').click();" type="checkbox" id="upto12k" name="rent" value="12000"  
                ...
                />
          <label for="upto12k">UPTO 12OOO</label>
          </li>
  ...
  <div class="row filter-fix">
	...
	<form class="houseType" onsubmit="return false" >
          <h5>Type of House</h5>
            <ul>
              ...
              <li>
  			  ...
  			  <li>
              	<input class="filled-in filter1" onclick="document.getElementById('sharing').click();" type="checkbox" id="SHARING" name="type" value="single_room"  
                <?php 
          ...
          <div class="priceRange">
            <ul>
              <li>
                ...
                />
  				<label for="UPTO1K">UPTO 1000</label>
  			  </li>
              <li>
              	<input class="filled-in filter1" onclick="document.getElementById('upto3k').click();" type="checkbox" id="UPTO3K" name="rent" value="3000"  
                ...
                />
  				<label for="UPTO3K">UPTO 3000</label>
  			  </li>
              <li>
              	<input class="filled-in filter1" onclick="document.getElementById('upto5k').click();" type="checkbox" id="UPTO5K" name="rent" value="5000"  
                ...
                />
  				<label for="UPTO5K">UPTO 5000</label>
  			  </li>
              <li>
              	<input class="filled-in filter1" onclick="document.getElementById('upto8k').click();" type="checkbox" id="UPTO8K" name="rent" value="8000"  
                ...
                />
  				<label for="UPTO8K">UPTO 8000</label>
  			  </li>
  			  <li>
              	<input class="filled-in filter1" type="checkbox" onclick="document.getElementById('upto12k').click();" id="UPTO12K" name="rent" value="12000"  
                ...
                />
  				<label for="UPTO12K">UPTO 12000</label>
  			  </li>
	 ...
	 <div class="col offset-m3 m19 offset-l2 l10 houses">
	 	...
	 	?>
	    <h5 style="text-align:center;color: #7d7d7d; "><?php echo $city; ?></h5>
          ...
          <form action="city.php" method="GET" class="col s12 offset-m2 m8 offset-l4 l4" style="padding:0px">      
            <div class="search-bar"> 
              ...
              <div class="col s5 m5 l4" style="padding: 0 0.75rem 0 1.45rem;">
                ...
                <input id="" type="date" name="date" placeholder="Enter date" required>
              </div>
      ...
      {
        echo "<center><h4>Nothing Found according to your search</h4></center>";
      }

			for ($x = 0; $x <= count($colony_list)-1; $x++) { 
				
				$image1 = "'"."view.php?id=".$id_list[$x]."&no=1"."'";
  ...
  function check()
  {
    ...
    if (a.toString() == "" ) {
      window.location = "city.php"+"?city="+<?php echo "'".$search_city."'" ?>+"&date="+<?php echo "'".$search_date."'" ?>+"" ;
    }
    else
    {
      window.location = "city.php"+"?filter="+a.toString()+"&city="+<?php echo "'".$search_city."'" ?>+"&date="+<?php echo "'".$search_date."'" ?>+"" ;
    }
